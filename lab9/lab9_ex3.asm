...
START_OF_MAIN_CODE					
	...
	JSRR r2 ;get first operand
	
	lea r0, enter_operand_msg_2
	PUTS
	...
	lea r0, enter_operation_sym_msg
	PUTS
	GETC
	OUT
	
	ld r2, multiply_rpn_sub_rout
	JSRR r2
	
	;result is pushed onto stack alone so we need to pop it
	
	ld r2, sub_stack_pop_rout 
	JSRR r2
	
	add r2, r0, #0 ;r2 = r0 because need r2 as input for print num sub rout
...
multiply_rpn_sub_rout .FILL x4000

enter_operand_msg_1 .stringz "\nEnter the first operand:\n"
enter_operand_msg_2 .stringz "\nEnter the second operand:\n"
enter_operation_sym_msg .stringz "\nEnter operation symbol:\n"
...
address_base .FILL x4200 ; first available is 4001 ;base is 1- first available
address_max	 .FILL x4205
address_tos	 .FILL x4200 ;4001
...
; Inputs: R1, which is guaranteed to be in range {0,15} :NOW INPUT IS R2
...
add r1, r1,#0 ;r1 = r1 
BRz SKIP_TO_OUTPUT_TENS ;if zero go to ones section
ld r3, num_10 ; r3 = 10
add r1, r1, r3   ;r1 = r1 +10
add r4, r4, #-1  ;-1 to counter
...
;r2 and r3 will do the multiplication

ld r1, sub_stack_pop_rout_2
JSRR r1

add r2, r0, #0 ; r2 will be equal to second operand


ld r1, sub_stack_pop_rout_2
JSRR r1

add r3, r0, #0 ; r3 will be equal to first operand
...
add r4,r2, #0 ; r4 = r2 (original value)




ld r2, clear_value_rpn_mult
...
add r0,r2, #0 ; r0 = r2 (product of loop)


ld r1, sub_stack_push_rout_2
JSRR r1			 
BR END_OF_RPN_MULT_SUB_ROUT
...
sub_stack_push_rout_2 .FILL x3200
sub_stack_pop_rout_2	.FILL x3400
clear_value_rpn_mult .FILL #0
;backup register values
backup_r0_3 .blkw #1
backup_r1_3	.blkw #1 
backup_r2_3 .blkw #1
